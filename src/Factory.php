...
class Factory
{
     ...
     * @return \Braumye\Illuminate\Http\Client\ResponseSequence
     */
     ...
     *
     * @param  string  $url
     * @param  \Braumye\Illuminate\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable  $callback
     * @return $this
     */
     ...
     *
     * @param  \Braumye\Illuminate\Http\Client\Request  $request
